...
namespace dotNet.models
{
    public class Calculadora
    {
        ...
        public void Potencia(int x, int y)
        {
            ...
            Console.WriteLine($" x^y: {x} elevado a {y} = {potencia}");

        }

        public void Seno(double angulo)
        {
            double radiano = angulo * Math.PI / 180; // calculo para converter para radiano
        ...
        {
            double numero = Math.Sqrt(raiz);
            Console.WriteLine($"Raiz de {raiz} é: {numero}");
        }
